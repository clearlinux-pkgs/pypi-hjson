...
Requires: pypi-hjson-license = %{version}-%{release}
...
%package license
Summary: license components for the pypi-hjson package.
Group: Default

%description license
license components for the pypi-hjson package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707120835
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pypi-hjson
cp %{_builddir}/hjson-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-hjson/c216e5760811b4343b44757fb3e10095bf0c43f0 || :
...
/usr/share/package-licenses/pypi-hjson/c216e5760811b4343b44757fb3e10095bf0c43f0
